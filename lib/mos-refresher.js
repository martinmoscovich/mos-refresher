  ...
  return {
    ...
    link: function(scope, $element, attrs, scrollCtrl) {
      ...
      function onDragEnd(e) {
        ...
        rotableElement.css({'-webkit-transform': '', '-moz-transform': '', '-ms-transform': '', 'transform': ''});
      ...
      function onDragDown(e) {
        ...
        if ( drag.distance <= (options.distanceToRefresh + options.extraDistance) ) {
          move(drag.distance);
          var rotateCss = 'rotate('+ percentageDone*3.6 +'deg)';
          rotableElement.css({'-webkit-transform': rotateCss, '-moz-transform': rotateCss, '-ms-transform': rotateCss, 'transform': rotateCss});
      ...
      function move(y) {
        var value = 'translate3d( 0, ' + ( y - $element[0].offsetHeight - 2) + 'px, 0 )';
        $element.css({'-webkit-transform': value, '-moz-transform': value, '-ms-transform': value, 'transform': value});
      }
